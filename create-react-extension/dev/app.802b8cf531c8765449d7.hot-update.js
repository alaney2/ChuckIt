...
function App() {
  const [website, setWebsite] = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(''); // let connection = mysql.createConnection(config);
  // useEffect(() => {
  ...
  function handleLike(e) {
    e.preventDefault(); // let insertwebsite = `INSERT INTO websites(url) VALUES('www.youtube.com');`;
...
//# sourceMappingURL=app.802b8cf531c8765449d7.hot-update.js.map